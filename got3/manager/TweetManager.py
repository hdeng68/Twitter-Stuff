...
class TweetManager:
    ...
    def getTweets(tweetCriteria, receiveBuffer=None, bufferLength=100, proxy=None):
        ...
        while active:
            ...
            for tweetHTML in tweets:
                ...
                geo = TweetManager.findLocation(usernameTweet.split()[0])
                ...
                tweet.username = usernameTweet.split()[0]

                tweet.txt = TweetManager.unicodeExtractor(txt)
                ...
                #tweet.geo = ''
                tweet.geo = TweetManager.tweetLocation(geo)
    ...
    @staticmethod
    def unicodeExtractor(tweetString):
        emojiList = []
    ...
    def findLocation(username):
        if username in TweetManager.locations:
            return TweetManager.locations[username]
        else:
            ...
            TweetManager.locations[username] = geo_location
